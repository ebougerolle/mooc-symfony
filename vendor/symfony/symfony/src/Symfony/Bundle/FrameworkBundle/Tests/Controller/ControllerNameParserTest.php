...
class ControllerNameParserTest extends TestCase
{
    ...
    public function testParse()
    {
        ...
        $this->assertEquals('TestBundle\FooBundle\Controller\DefaultController::indexAction', $parser->parse('FooBundle:Core:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        ...
        $this->assertEquals('TestBundle\Fabpot\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioFooBundle:Core:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\Sensio\Cms\FooBundle\Controller\DefaultController::indexAction', $parser->parse('SensioCmsFooBundle:Core:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test\\Core:index'), '->parse() converts a short a:b:c notation string to a class::method string');
        $this->assertEquals('TestBundle\FooBundle\Controller\Test\DefaultController::indexAction', $parser->parse('FooBundle:Test/Core:index'), '->parse() converts a short a:b:c notation string to a class::method string');
    ...
    public function testBuild()
    {
        ...
        $this->assertEquals('FoooooBundle:Core:index', $parser->build('TestBundle\FooBundle\Controller\DefaultController::indexAction'), '->parse() converts a class::method string to a short a:b:c notation string');
    ...
    {
        return array(
            'Alternative will be found using levenshtein' => array('FoodBundle:Core:index', 'FooBundle:Core:index'),
            'Alternative will be found using partial match' => array('FabpotFooBund:Core:index', 'FabpotFooBundle:Core:index'),
            'Bundle does not exist at all' => array('CrazyBundle:Core:index', false),
        );
    }
