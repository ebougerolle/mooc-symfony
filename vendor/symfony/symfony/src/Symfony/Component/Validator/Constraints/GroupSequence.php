 ...
 * checks fail.
 *
 * When adding metadata to a class, you can override the "Core" group of
 ...
 *     }
 *
 * Whenever you validate that object in the "Core" group, the group sequence
 * will be validated:
 *
 *     $validator->validate($address);
 *
 * If you want to execute the constraints of the "Core" group for a class
...
class GroupSequence
{
     ...
     * "Core" group. When validating that class in the "Core" group, the
     * group sequence is used instead, but still the "Core" group should be
