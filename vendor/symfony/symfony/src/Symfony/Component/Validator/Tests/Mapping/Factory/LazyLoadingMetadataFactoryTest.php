...
class LazyLoadingMetadataFactoryTest extends TestCase
{
    ...
    public function testLoadClassMetadataWithInterface()
    {
        ...
        $constraints = array(
            new ConstraintA(array('groups' => array('Core', 'EntityParent'))),
            new ConstraintA(array('groups' => array('Core', 'EntityInterfaceA', 'EntityParent'))),
        );
    ...
    public function testWriteMetadataToCache()
    {
        ...
        $interfaceAConstraints = array(
            new ConstraintA(array('groups' => array('Core', 'EntityInterfaceA'))),
        );
    ...
    public function testGroupsFromParent()
    {
        ...
        $this->assertContains('Core', $groups);
