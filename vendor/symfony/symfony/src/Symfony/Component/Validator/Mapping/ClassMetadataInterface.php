 ...
 *
 * Additionally, the metadata stores whether the "Core" group is overridden
...
interface ClassMetadataInterface extends MetadataInterface
{
    ...
    /**
     * Returns whether the "Core" group is overridden by a group sequence.
     *
     * If it is, you can access the group sequence with {@link getGroupSequence()}.
     *
     * @return bool Returns true if the "Core" group is overridden
     *
     * @see \Symfony\Component\Validator\Constraints\GroupSequence
     */
    ...
    /**
     * Returns whether the "Core" group is overridden by a dynamic group
     ...
     *
     * @return bool Returns true if the "Core" group is overridden by
