...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
     ...
     * metadata.
     *
     * If the passed groups contain the group "Core", the validator will
     * check whether the "Core" group has been replaced by a group sequence
    ...
    private function validateClassNode($object, $cacheKey, ClassMetadataInterface $metadata = null, $propertyPath, array $groups, $cascadedGroups, $traversalStrategy, ExecutionContextInterface $context)
    {
        ...
        foreach ($groups as $key => $group) {
            // If the "Core" group is replaced by a group sequence, remember
            // to cascade the "Core" group when traversing the group
            // sequence
            ...
            // "Core" is used instead in the cache. This is useful
