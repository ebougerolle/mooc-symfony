...
class SimpleAuthenticationHandler implements AuthenticationFailureHandlerInterface, AuthenticationSuccessHandlerInterface
{
     ...
     * @param AuthenticationSuccessHandlerInterface $successHandler Core success handler
     * @param AuthenticationFailureHandlerInterface $failureHandler Core failure handler
